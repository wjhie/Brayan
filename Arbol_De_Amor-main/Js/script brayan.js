...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `\n\n  Esto es una pruba, tu sabes que te quiero.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Brayan";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `El tiempo pasa...: <b>${days}</b> días<br>` +
      `y yo siguo esperando el momentoperfecto para decirte lo que siento: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
